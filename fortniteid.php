...
<div class="content">
          ...
          <?php
            ...
            class QueryHandler {
                ...
                public function handleQuery($user_question) {
                    ...
                    $sql = "SELECT player_name, win, winrate, kills, headshot_percentage, weapon_used, mvp, overall_total_score FROM fortnite";
          ...
          <script>
            document.addEventListener("DOMContentLoaded", () => {
              ...
              const renderChart = () => {
                ...
                fetch(`fetch_data_fortnite.php?${params.toString()}`)
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Fortnite Player Statistic Table in Detail</h5>
